...
import { Home1CoberturaComponent } from "./components/home1-case-studies/home1-case-studies.component";
...
@Component({
  selector: 'app-home1',
  imports: [LayoutComponent, Home1HeroComponent, Home1AboutComponent, Home1ServiceComponent, Home1WorkComponent, Home1CoberturaComponent, Home1TestimonialComponent, Home1TeamComponent, Home1BlogsComponent],
